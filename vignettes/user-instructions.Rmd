...
The `f_upsert_location` function will let you upload new locations to the NaTRON database. The format of the data to be uploaded must exactly the same as the NaTRON database table.
